...
let Footer = () => {
  return (
    <div class="bg-white dark:bg-gray-900 w-full p-5 mt-auto">
      <div class="flex flex-col md:flex-row w-full justify-center space-y-10 md:space-y-0 md:space-x-10">
        ...
        <div class="flex flex-col items-center space-y-5">
          <div class="w-full text-lg text-center font-bold text-green-900 dark:text-green-600">
            Get social with us!
          </div>
          ...
          <div class="flex justify-center space-x-5 items-center">
            ...
            >
              <svg
                ...
                class="w-8 h-8 fill-green-900 dark:fill-green-600"
              >
        ...
        <div class="flex flex-col space-y-5">
          <div class="w-full text-lg font-bold text-green-900 dark:text-green-600">
            Share your thoughts!
          </div>
